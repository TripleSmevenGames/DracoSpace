...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Unnamed Game", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Unnamed Game", null, 1280, 960);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Unnamed Game";
		app.meta["name"] = "Unnamed Game";
