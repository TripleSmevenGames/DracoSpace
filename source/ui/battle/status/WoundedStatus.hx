...
class WoundedStatus extends DebuffStatus
{
	...
	{
		updateTooltip('${owner.info.name}\'s takes more damage from enemy skills for $valAfter turn(s).');
	}
	...
	public function new(owner:CharacterSprite, initialStacks:Int = 1)
	{
		type = WOUNDED;
		name = 'Wounded';
		var desc = '${owner.info.name}\'s takes more damage from enemy skills for $initialStacks turn(s).';
